...
?>
<?= $form->field($model, 'title', ['inputOptions'=> ['class'=>'label_indx1']]) ?>

<?= $form->field($model, 'address', ['inputOptions'=> ['class'=>'label_indx']])->textInput(['autofocus' => true]) ?>

<?= $form->field($model, 'state', ['inputOptions'=> ['class'=>'label_indx1']])->dropDownList(['Em andamento'=>'Em andamento','Finalizado'=>'Finalizado'],['prompt' => 'Selecionar estado do projeto']) ?>
